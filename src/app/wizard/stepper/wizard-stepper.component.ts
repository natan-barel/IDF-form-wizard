...
import { WelcomeStepComponent } from '@wizard/steps/welcome-step/welcome-step.component';
import { PreviousEducationStepComponent } from '@wizard/steps/previous-education-step/previous-education-step.component';
...
export class WizardStepperComponent
  ...
  override ngOnInit(): void {
    let initalSteps: Array<StepPageObject> = [
      { component: WelcomeStepComponent, label: '', icon: 'user', title: "welcome" },
      { component: PreviousEducationStepComponent, label: '', icon: 'book', title: "welcome" },
      // { component: WelcomeStepComponent, label: '', icon: 'user', title: "welcome" },
